...
package STM32.DBG is
   ...
   subtype IDCODE_DEV_ID_Field is STM32.UInt12;
   subtype IDCODE_REV_ID_Field is STM32.Short;
   ...
   subtype CR_DBG_SLEEP_Field is STM32.Bit;
   subtype CR_DBG_STOP_Field is STM32.Bit;
   subtype CR_DBG_STANDBY_Field is STM32.Bit;
   subtype CR_TRACE_IOEN_Field is STM32.Bit;
   subtype CR_TRACE_MODE_Field is STM32.UInt2;
   subtype CR_DBG_IWDG_STOP_Field is STM32.Bit;
   subtype CR_DBG_WWDG_STOP_Field is STM32.Bit;
   subtype CR_DBG_TIM1_STOP_Field is STM32.Bit;
   subtype CR_DBG_TIM2_STOP_Field is STM32.Bit;
   subtype CR_DBG_TIM3_STOP_Field is STM32.Bit;
   subtype CR_DBG_TIM4_STOP_Field is STM32.Bit;
   subtype CR_DBG_CAN1_STOP_Field is STM32.Bit;
   subtype CR_DBG_I2C1_SMBUS_TIMEOUT_Field is STM32.Bit;
   subtype CR_DBG_I2C2_SMBUS_TIMEOUT_Field is STM32.Bit;
   subtype CR_DBG_TIM8_STOP_Field is STM32.Bit;
   subtype CR_DBG_TIM5_STOP_Field is STM32.Bit;
   subtype CR_DBG_TIM6_STOP_Field is STM32.Bit;
   subtype CR_DBG_TIM7_STOP_Field is STM32.Bit;
   subtype CR_DBG_CAN2_STOP_Field is STM32.Bit;
