...
package STM32.IWDG is
   ...
   subtype KR_KEY_Field is STM32.Short;
   ...
   subtype PR_PR_Field is STM32.UInt3;
   ...
   subtype RLR_RL_Field is STM32.UInt12;
   ...
   subtype SR_PVU_Field is STM32.Bit;
   subtype SR_RVU_Field is STM32.Bit;
