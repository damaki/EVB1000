...
package STM32.ADC is
   ...
   subtype SR_AWD_Field is STM32.Bit;
   subtype SR_EOC_Field is STM32.Bit;
   subtype SR_JEOC_Field is STM32.Bit;
   subtype SR_JSTRT_Field is STM32.Bit;
   subtype SR_STRT_Field is STM32.Bit;
   ...
   subtype CR1_AWDCH_Field is STM32.UInt5;
   subtype CR1_EOCIE_Field is STM32.Bit;
   subtype CR1_AWDIE_Field is STM32.Bit;
   subtype CR1_JEOCIE_Field is STM32.Bit;
   subtype CR1_SCAN_Field is STM32.Bit;
   subtype CR1_AWDSGL_Field is STM32.Bit;
   subtype CR1_JAUTO_Field is STM32.Bit;
   subtype CR1_DISCEN_Field is STM32.Bit;
   subtype CR1_JDISCEN_Field is STM32.Bit;
   subtype CR1_DISCNUM_Field is STM32.UInt3;
   subtype CR1_DUALMOD_Field is STM32.UInt4;
   subtype CR1_JAWDEN_Field is STM32.Bit;
   subtype CR1_AWDEN_Field is STM32.Bit;
   ...
   type CR1_Register is record
      ...
      --  unspecified
      Reserved_20_21 : STM32.UInt2 := 16#0#;
   ...
   subtype CR2_ADON_Field is STM32.Bit;
   subtype CR2_CONT_Field is STM32.Bit;
   subtype CR2_CAL_Field is STM32.Bit;
   subtype CR2_RSTCAL_Field is STM32.Bit;
   subtype CR2_DMA_Field is STM32.Bit;
   subtype CR2_ALIGN_Field is STM32.Bit;
   subtype CR2_JEXTSEL_Field is STM32.UInt3;
   subtype CR2_JEXTTRIG_Field is STM32.Bit;
   subtype CR2_EXTSEL_Field is STM32.UInt3;
   subtype CR2_EXTTRIG_Field is STM32.Bit;
   subtype CR2_JSWSTART_Field is STM32.Bit;
   subtype CR2_SWSTART_Field is STM32.Bit;
   subtype CR2_TSVREFE_Field is STM32.Bit;
   ...
   type CR2_Register is record
      ...
      --  unspecified
      Reserved_9_10  : STM32.UInt2 := 16#0#;
      --  Data alignment
   ...
   subtype SMPR1_SMP_Element is STM32.UInt3;
   ...
   type SMPR1_Register is record
      ...
      --  unspecified
      Reserved_27_31 : STM32.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SMPR2_SMP_Element is STM32.UInt3;
   ...
   subtype JOFR1_JOFFSET1_Field is STM32.UInt12;
   ...
   subtype JOFR2_JOFFSET2_Field is STM32.UInt12;
   ...
   subtype JOFR3_JOFFSET3_Field is STM32.UInt12;
   ...
   subtype JOFR4_JOFFSET4_Field is STM32.UInt12;
   ...
   subtype HTR_HT_Field is STM32.UInt12;
   ...
   subtype LTR_LT_Field is STM32.UInt12;
   ...
   subtype SQR1_SQ_Element is STM32.UInt5;
   ...
   subtype SQR1_L_Field is STM32.UInt4;
   ...
   subtype SQR2_SQ_Element is STM32.UInt5;
   ...
   subtype SQR3_SQ_Element is STM32.UInt5;
   ...
   subtype JSQR_JSQ_Element is STM32.UInt5;
   ...
   subtype JSQR_JL_Field is STM32.UInt2;
   ...
   type JSQR_Register is record
      ...
      --  unspecified
      Reserved_22_31 : STM32.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype JDR1_JDATA_Field is STM32.Short;
   ...
   subtype DR_DATA_Field is STM32.Short;
   subtype DR_ADC2DATA_Field is STM32.Short;
   ...
   type CR1_Register_1 is record
      ...
      DISCNUM        : CR1_DISCNUM_Field := 16#0#;
      --  unspecified
      Reserved_16_21 : STM32.UInt6 := 16#0#;
      --  Analog watchdog enable on injected channels
      JAWDEN         : CR1_JAWDEN_Field := 16#0#;
      --  Analog watchdog enable on regular channels
      AWDEN          : CR1_AWDEN_Field := 16#0#;
