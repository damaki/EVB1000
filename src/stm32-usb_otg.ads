...
package STM32.USB_OTG is
   ...
   subtype FS_GOTGCTL_SRQSCS_Field is STM32.Bit;
   subtype FS_GOTGCTL_SRQ_Field is STM32.Bit;
   subtype FS_GOTGCTL_HNGSCS_Field is STM32.Bit;
   subtype FS_GOTGCTL_HNPRQ_Field is STM32.Bit;
   subtype FS_GOTGCTL_HSHNPEN_Field is STM32.Bit;
   subtype FS_GOTGCTL_DHNPEN_Field is STM32.Bit;
   subtype FS_GOTGCTL_CIDSTS_Field is STM32.Bit;
   subtype FS_GOTGCTL_DBCT_Field is STM32.Bit;
   subtype FS_GOTGCTL_ASVLD_Field is STM32.Bit;
   subtype FS_GOTGCTL_BSVLD_Field is STM32.Bit;
   ...
   subtype FS_GOTGINT_SEDET_Field is STM32.Bit;
   subtype FS_GOTGINT_SRSSCHG_Field is STM32.Bit;
   subtype FS_GOTGINT_HNSSCHG_Field is STM32.Bit;
   subtype FS_GOTGINT_HNGDET_Field is STM32.Bit;
   subtype FS_GOTGINT_ADTOCHG_Field is STM32.Bit;
   subtype FS_GOTGINT_DBCDNE_Field is STM32.Bit;

   --  OTG_FS interrupt register (OTG_FS_GOTGINT)
   type FS_GOTGINT_Register is record
      --  unspecified
      Reserved_0_1   : STM32.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_10_16 : STM32.UInt7 := 16#0#;
   ...
   subtype FS_GAHBCFG_GINT_Field is STM32.Bit;
   subtype FS_GAHBCFG_TXFELVL_Field is STM32.Bit;
   subtype FS_GAHBCFG_PTXFELVL_Field is STM32.Bit;
   ...
   subtype FS_GUSBCFG_TOCAL_Field is STM32.UInt3;
   subtype FS_GUSBCFG_PHYSEL_Field is STM32.Bit;
   subtype FS_GUSBCFG_SRPCAP_Field is STM32.Bit;
   subtype FS_GUSBCFG_HNPCAP_Field is STM32.Bit;
   subtype FS_GUSBCFG_TRDT_Field is STM32.UInt4;
   subtype FS_GUSBCFG_FHMOD_Field is STM32.Bit;
   subtype FS_GUSBCFG_FDMOD_Field is STM32.Bit;
   subtype FS_GUSBCFG_CTXPKT_Field is STM32.Bit;
   ...
   type FS_GUSBCFG_Register is record
      ...
      --  unspecified
      Reserved_14_28 : STM32.UInt15 := 16#0#;
      --  Force host mode
   ...
   subtype FS_GRSTCTL_CSRST_Field is STM32.Bit;
   subtype FS_GRSTCTL_HSRST_Field is STM32.Bit;
   subtype FS_GRSTCTL_FCRST_Field is STM32.Bit;
   subtype FS_GRSTCTL_RXFFLSH_Field is STM32.Bit;
   subtype FS_GRSTCTL_TXFFLSH_Field is STM32.Bit;
   subtype FS_GRSTCTL_TXFNUM_Field is STM32.UInt5;
   subtype FS_GRSTCTL_AHBIDL_Field is STM32.Bit;
   ...
   type FS_GRSTCTL_Register is record
      ...
      --  unspecified
      Reserved_11_30 : STM32.UInt20 := 16#40000#;
   ...
   subtype FS_GINTSTS_CMOD_Field is STM32.Bit;
   subtype FS_GINTSTS_MMIS_Field is STM32.Bit;
   subtype FS_GINTSTS_OTGINT_Field is STM32.Bit;
   subtype FS_GINTSTS_SOF_Field is STM32.Bit;
   subtype FS_GINTSTS_RXFLVL_Field is STM32.Bit;
   subtype FS_GINTSTS_NPTXFE_Field is STM32.Bit;
   subtype FS_GINTSTS_GINAKEFF_Field is STM32.Bit;
   subtype FS_GINTSTS_GOUTNAKEFF_Field is STM32.Bit;
   subtype FS_GINTSTS_ESUSP_Field is STM32.Bit;
   subtype FS_GINTSTS_USBSUSP_Field is STM32.Bit;
   subtype FS_GINTSTS_USBRST_Field is STM32.Bit;
   subtype FS_GINTSTS_ENUMDNE_Field is STM32.Bit;
   subtype FS_GINTSTS_ISOODRP_Field is STM32.Bit;
   subtype FS_GINTSTS_EOPF_Field is STM32.Bit;
   subtype FS_GINTSTS_IEPINT_Field is STM32.Bit;
   subtype FS_GINTSTS_OEPINT_Field is STM32.Bit;
   subtype FS_GINTSTS_IISOIXFR_Field is STM32.Bit;
   subtype FS_GINTSTS_IPXFR_INCOMPISOOUT_Field is STM32.Bit;
   subtype FS_GINTSTS_HPRTINT_Field is STM32.Bit;
   subtype FS_GINTSTS_HCINT_Field is STM32.Bit;
   subtype FS_GINTSTS_PTXFE_Field is STM32.Bit;
   subtype FS_GINTSTS_CIDSCHG_Field is STM32.Bit;
   subtype FS_GINTSTS_DISCINT_Field is STM32.Bit;
   subtype FS_GINTSTS_SRQINT_Field is STM32.Bit;
   subtype FS_GINTSTS_WKUPINT_Field is STM32.Bit;
   ...
   type FS_GINTSTS_Register is record
      ...
      --  unspecified
      Reserved_16_17     : STM32.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_22_23     : STM32.UInt2 := 16#0#;
   ...
   subtype FS_GINTMSK_MMISM_Field is STM32.Bit;
   subtype FS_GINTMSK_OTGINT_Field is STM32.Bit;
   subtype FS_GINTMSK_SOFM_Field is STM32.Bit;
   subtype FS_GINTMSK_RXFLVLM_Field is STM32.Bit;
   subtype FS_GINTMSK_NPTXFEM_Field is STM32.Bit;
   subtype FS_GINTMSK_GINAKEFFM_Field is STM32.Bit;
   subtype FS_GINTMSK_GONAKEFFM_Field is STM32.Bit;
   subtype FS_GINTMSK_ESUSPM_Field is STM32.Bit;
   subtype FS_GINTMSK_USBSUSPM_Field is STM32.Bit;
   subtype FS_GINTMSK_USBRST_Field is STM32.Bit;
   subtype FS_GINTMSK_ENUMDNEM_Field is STM32.Bit;
   subtype FS_GINTMSK_ISOODRPM_Field is STM32.Bit;
   subtype FS_GINTMSK_EOPFM_Field is STM32.Bit;
   subtype FS_GINTMSK_EPMISM_Field is STM32.Bit;
   subtype FS_GINTMSK_IEPINT_Field is STM32.Bit;
   subtype FS_GINTMSK_OEPINT_Field is STM32.Bit;
   subtype FS_GINTMSK_IISOIXFRM_Field is STM32.Bit;
   subtype FS_GINTMSK_IPXFRM_IISOOXFRM_Field is STM32.Bit;
   subtype FS_GINTMSK_PRTIM_Field is STM32.Bit;
   subtype FS_GINTMSK_HCIM_Field is STM32.Bit;
   subtype FS_GINTMSK_PTXFEM_Field is STM32.Bit;
   subtype FS_GINTMSK_CIDSCHGM_Field is STM32.Bit;
   subtype FS_GINTMSK_DISCINT_Field is STM32.Bit;
   subtype FS_GINTMSK_SRQIM_Field is STM32.Bit;
   subtype FS_GINTMSK_WUIM_Field is STM32.Bit;

   --  OTG_FS interrupt mask register (OTG_FS_GINTMSK)
   type FS_GINTMSK_Register is record
      --  unspecified
      Reserved_0_0     : STM32.Bit := 16#0#;
   ...
   subtype FS_GRXSTSR_Device_EPNUM_Field is STM32.UInt4;
   subtype FS_GRXSTSR_Device_BCNT_Field is STM32.UInt11;
   subtype FS_GRXSTSR_Device_DPID_Field is STM32.UInt2;
   subtype FS_GRXSTSR_Device_PKTSTS_Field is STM32.UInt4;
   subtype FS_GRXSTSR_Device_FRMNUM_Field is STM32.UInt4;
   ...
   subtype FS_GRXSTSR_Host_EPNUM_Field is STM32.UInt4;
   subtype FS_GRXSTSR_Host_BCNT_Field is STM32.UInt11;
   subtype FS_GRXSTSR_Host_DPID_Field is STM32.UInt2;
   subtype FS_GRXSTSR_Host_PKTSTS_Field is STM32.UInt4;
   subtype FS_GRXSTSR_Host_FRMNUM_Field is STM32.UInt4;
   ...
   subtype FS_GRXFSIZ_RXFD_Field is STM32.Short;
   ...
   subtype FS_GNPTXFSIZ_Device_TX0FSA_Field is STM32.Short;
   subtype FS_GNPTXFSIZ_Device_TX0FD_Field is STM32.Short;
   ...
   subtype FS_GNPTXFSIZ_Host_NPTXFSA_Field is STM32.Short;
   subtype FS_GNPTXFSIZ_Host_NPTXFD_Field is STM32.Short;
   ...
   subtype FS_GNPTXSTS_NPTXFSAV_Field is STM32.Short;
   subtype FS_GNPTXSTS_NPTQXSAV_Field is STM32.Byte;
   subtype FS_GNPTXSTS_NPTXQTOP_Field is STM32.UInt7;
   ...
   subtype FS_GCCFG_PWRDWN_Field is STM32.Bit;
   subtype FS_GCCFG_VBUSASEN_Field is STM32.Bit;
   subtype FS_GCCFG_VBUSBSEN_Field is STM32.Bit;
   subtype FS_GCCFG_SOFOUTEN_Field is STM32.Bit;

   --  OTG_FS general core configuration register (OTG_FS_GCCFG)
   type FS_GCCFG_Register is record
      --  unspecified
      Reserved_0_15  : STM32.Short := 16#0#;
      --  Power down
      PWRDWN         : FS_GCCFG_PWRDWN_Field := 16#0#;
      --  unspecified
      Reserved_17_17 : STM32.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_21_31 : STM32.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FS_HPTXFSIZ_PTXSA_Field is STM32.Short;
   subtype FS_HPTXFSIZ_PTXFSIZ_Field is STM32.Short;
   ...
   subtype FS_DIEPTXF1_INEPTXSA_Field is STM32.Short;
   subtype FS_DIEPTXF1_INEPTXFD_Field is STM32.Short;
   ...
   subtype FS_HCFG_FSLSPCS_Field is STM32.UInt2;
   subtype FS_HCFG_FSLSS_Field is STM32.Bit;
   ...
   subtype HFIR_FRIVL_Field is STM32.Short;
   ...
   subtype FS_HFNUM_FRNUM_Field is STM32.Short;
   subtype FS_HFNUM_FTREM_Field is STM32.Short;
   ...
   subtype FS_HPTXSTS_PTXFSAVL_Field is STM32.Short;
   subtype FS_HPTXSTS_PTXQSAV_Field is STM32.Byte;
   ...
   subtype HAINT_HAINT_Field is STM32.Short;
   ...
   subtype HAINTMSK_HAINTM_Field is STM32.Short;
   ...
   subtype FS_HPRT_PCSTS_Field is STM32.Bit;
   subtype FS_HPRT_PCDET_Field is STM32.Bit;
   subtype FS_HPRT_PENA_Field is STM32.Bit;
   subtype FS_HPRT_PENCHNG_Field is STM32.Bit;
   subtype FS_HPRT_POCA_Field is STM32.Bit;
   subtype FS_HPRT_POCCHNG_Field is STM32.Bit;
   subtype FS_HPRT_PRES_Field is STM32.Bit;
   subtype FS_HPRT_PSUSP_Field is STM32.Bit;
   subtype FS_HPRT_PRST_Field is STM32.Bit;
   subtype FS_HPRT_PLSTS_Field is STM32.UInt2;
   subtype FS_HPRT_PPWR_Field is STM32.Bit;
   subtype FS_HPRT_PTCTL_Field is STM32.UInt4;
   subtype FS_HPRT_PSPD_Field is STM32.UInt2;
   ...
   subtype FS_HCCHAR0_MPSIZ_Field is STM32.UInt11;
   subtype FS_HCCHAR0_EPNUM_Field is STM32.UInt4;
   subtype FS_HCCHAR0_EPDIR_Field is STM32.Bit;
   subtype FS_HCCHAR0_LSDEV_Field is STM32.Bit;
   subtype FS_HCCHAR0_EPTYP_Field is STM32.UInt2;
   subtype FS_HCCHAR0_MCNT_Field is STM32.UInt2;
   subtype FS_HCCHAR0_DAD_Field is STM32.UInt7;
   subtype FS_HCCHAR0_ODDFRM_Field is STM32.Bit;
   subtype FS_HCCHAR0_CHDIS_Field is STM32.Bit;
   subtype FS_HCCHAR0_CHENA_Field is STM32.Bit;
   ...
   subtype FS_HCINT0_XFRC_Field is STM32.Bit;
   subtype FS_HCINT0_CHH_Field is STM32.Bit;
   subtype FS_HCINT0_STALL_Field is STM32.Bit;
   subtype FS_HCINT0_NAK_Field is STM32.Bit;
   subtype FS_HCINT0_ACK_Field is STM32.Bit;
   subtype FS_HCINT0_TXERR_Field is STM32.Bit;
   subtype FS_HCINT0_BBERR_Field is STM32.Bit;
   subtype FS_HCINT0_FRMOR_Field is STM32.Bit;
   subtype FS_HCINT0_DTERR_Field is STM32.Bit;
   ...
   subtype FS_HCINTMSK0_XFRCM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_CHHM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_STALLM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_NAKM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_ACKM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_NYET_Field is STM32.Bit;
   subtype FS_HCINTMSK0_TXERRM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_BBERRM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_FRMORM_Field is STM32.Bit;
   subtype FS_HCINTMSK0_DTERRM_Field is STM32.Bit;
   ...
   subtype FS_HCTSIZ0_XFRSIZ_Field is STM32.UInt19;
   subtype FS_HCTSIZ0_PKTCNT_Field is STM32.UInt10;
   subtype FS_HCTSIZ0_DPID_Field is STM32.UInt2;
   ...
   subtype FS_DCFG_DSPD_Field is STM32.UInt2;
   subtype FS_DCFG_NZLSOHSK_Field is STM32.Bit;
   subtype FS_DCFG_DAD_Field is STM32.UInt7;
   subtype FS_DCFG_PFIVL_Field is STM32.UInt2;
   ...
   type FS_DCFG_Register is record
      ...
      --  unspecified
      Reserved_13_31 : STM32.UInt19 := 16#1100#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FS_DCTL_RWUSIG_Field is STM32.Bit;
   subtype FS_DCTL_SDIS_Field is STM32.Bit;
   subtype FS_DCTL_GINSTS_Field is STM32.Bit;
   subtype FS_DCTL_GONSTS_Field is STM32.Bit;
   subtype FS_DCTL_TCTL_Field is STM32.UInt3;
   subtype FS_DCTL_SGINAK_Field is STM32.Bit;
   subtype FS_DCTL_CGINAK_Field is STM32.Bit;
   subtype FS_DCTL_SGONAK_Field is STM32.Bit;
   subtype FS_DCTL_CGONAK_Field is STM32.Bit;
   subtype FS_DCTL_POPRGDNE_Field is STM32.Bit;
   ...
   subtype FS_DSTS_SUSPSTS_Field is STM32.Bit;
   subtype FS_DSTS_ENUMSPD_Field is STM32.UInt2;
   subtype FS_DSTS_EERR_Field is STM32.Bit;
   subtype FS_DSTS_FNSOF_Field is STM32.UInt14;
   ...
   subtype FS_DIEPMSK_XFRCM_Field is STM32.Bit;
   subtype FS_DIEPMSK_EPDM_Field is STM32.Bit;
   subtype FS_DIEPMSK_TOM_Field is STM32.Bit;
   subtype FS_DIEPMSK_ITTXFEMSK_Field is STM32.Bit;
   subtype FS_DIEPMSK_INEPNMM_Field is STM32.Bit;
   subtype FS_DIEPMSK_INEPNEM_Field is STM32.Bit;
   ...
   type FS_DIEPMSK_Register is record
      ...
      --  unspecified
      Reserved_7_31 : STM32.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FS_DOEPMSK_XFRCM_Field is STM32.Bit;
   subtype FS_DOEPMSK_EPDM_Field is STM32.Bit;
   subtype FS_DOEPMSK_STUPM_Field is STM32.Bit;
   subtype FS_DOEPMSK_OTEPDM_Field is STM32.Bit;
   ...
   type FS_DOEPMSK_Register is record
      ...
      --  unspecified
      Reserved_5_31 : STM32.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FS_DAINT_IEPINT_Field is STM32.Short;
   subtype FS_DAINT_OEPINT_Field is STM32.Short;
   ...
   subtype FS_DAINTMSK_IEPM_Field is STM32.Short;
   subtype FS_DAINTMSK_OEPINT_Field is STM32.Short;
   ...
   subtype DVBUSDIS_VBUSDT_Field is STM32.Short;
   ...
   subtype DVBUSPULSE_DVBUSP_Field is STM32.UInt12;
   ...
   subtype DIEPEMPMSK_INEPTXFEM_Field is STM32.Short;
   ...
   subtype FS_DIEPCTL0_MPSIZ_Field is STM32.UInt2;
   subtype FS_DIEPCTL0_USBAEP_Field is STM32.Bit;
   subtype FS_DIEPCTL0_NAKSTS_Field is STM32.Bit;
   subtype FS_DIEPCTL0_EPTYP_Field is STM32.UInt2;
   subtype FS_DIEPCTL0_STALL_Field is STM32.Bit;
   subtype FS_DIEPCTL0_TXFNUM_Field is STM32.UInt4;
   subtype FS_DIEPCTL0_CNAK_Field is STM32.Bit;
   subtype FS_DIEPCTL0_SNAK_Field is STM32.Bit;
   subtype FS_DIEPCTL0_EPDIS_Field is STM32.Bit;
   subtype FS_DIEPCTL0_EPENA_Field is STM32.Bit;
   ...
   type FS_DIEPCTL0_Register is record
      ...
      --  unspecified
      Reserved_2_14  : STM32.UInt13 := 16#0#;
      ...
      --  unspecified
      Reserved_28_29 : STM32.UInt2 := 16#0#;
   ...
   subtype DIEPINT0_XFRC_Field is STM32.Bit;
   subtype DIEPINT0_EPDISD_Field is STM32.Bit;
   subtype DIEPINT0_TOC_Field is STM32.Bit;
   subtype DIEPINT0_ITTXFE_Field is STM32.Bit;
   subtype DIEPINT0_INEPNE_Field is STM32.Bit;
   subtype DIEPINT0_TXFE_Field is STM32.Bit;
   ...
   subtype DIEPTSIZ0_XFRSIZ_Field is STM32.UInt7;
   subtype DIEPTSIZ0_PKTCNT_Field is STM32.UInt2;
   ...
   type DIEPTSIZ0_Register is record
      ...
      --  unspecified
      Reserved_7_18  : STM32.UInt12 := 16#0#;
      --  Packet count
   ...
   subtype DTXFSTS0_INEPTFSAV_Field is STM32.Short;
   ...
   subtype DIEPCTL1_MPSIZ_Field is STM32.UInt11;
   subtype DIEPCTL1_USBAEP_Field is STM32.Bit;
   subtype DIEPCTL1_EONUM_DPID_Field is STM32.Bit;
   subtype DIEPCTL1_NAKSTS_Field is STM32.Bit;
   subtype DIEPCTL1_EPTYP_Field is STM32.UInt2;
   subtype DIEPCTL1_Stall_Field is STM32.Bit;
   subtype DIEPCTL1_TXFNUM_Field is STM32.UInt4;
   subtype DIEPCTL1_CNAK_Field is STM32.Bit;
   subtype DIEPCTL1_SNAK_Field is STM32.Bit;
   subtype DIEPCTL1_SD0PID_SEVNFRM_Field is STM32.Bit;
   subtype DIEPCTL1_SODDFRM_SD1PID_Field is STM32.Bit;
   subtype DIEPCTL1_EPDIS_Field is STM32.Bit;
   subtype DIEPCTL1_EPENA_Field is STM32.Bit;
   ...
   type DIEPCTL1_Register is record
      ...
      --  unspecified
      Reserved_11_14 : STM32.UInt4 := 16#0#;
      --  USBAEP
   ...
   subtype DIEPTSIZ1_XFRSIZ_Field is STM32.UInt19;
   subtype DIEPTSIZ1_PKTCNT_Field is STM32.UInt10;
   subtype DIEPTSIZ1_MCNT_Field is STM32.UInt2;
   ...
   subtype DIEPCTL2_MPSIZ_Field is STM32.UInt11;
   subtype DIEPCTL2_USBAEP_Field is STM32.Bit;
   subtype DIEPCTL2_EONUM_DPID_Field is STM32.Bit;
   subtype DIEPCTL2_NAKSTS_Field is STM32.Bit;
   subtype DIEPCTL2_EPTYP_Field is STM32.UInt2;
   subtype DIEPCTL2_Stall_Field is STM32.Bit;
   subtype DIEPCTL2_TXFNUM_Field is STM32.UInt4;
   subtype DIEPCTL2_CNAK_Field is STM32.Bit;
   subtype DIEPCTL2_SNAK_Field is STM32.Bit;
   subtype DIEPCTL2_SD0PID_SEVNFRM_Field is STM32.Bit;
   subtype DIEPCTL2_SODDFRM_Field is STM32.Bit;
   subtype DIEPCTL2_EPDIS_Field is STM32.Bit;
   subtype DIEPCTL2_EPENA_Field is STM32.Bit;
   ...
   subtype DOEPCTL0_MPSIZ_Field is STM32.UInt2;
   subtype DOEPCTL0_USBAEP_Field is STM32.Bit;
   subtype DOEPCTL0_NAKSTS_Field is STM32.Bit;
   subtype DOEPCTL0_EPTYP_Field is STM32.UInt2;
   subtype DOEPCTL0_SNPM_Field is STM32.Bit;
   subtype DOEPCTL0_Stall_Field is STM32.Bit;
   subtype DOEPCTL0_CNAK_Field is STM32.Bit;
   subtype DOEPCTL0_SNAK_Field is STM32.Bit;
   subtype DOEPCTL0_EPDIS_Field is STM32.Bit;
   subtype DOEPCTL0_EPENA_Field is STM32.Bit;
   ...
   type DOEPCTL0_Register is record
      ...
      --  unspecified
      Reserved_22_25 : STM32.UInt4 := 16#0#;
      --  Write-only. CNAK
   ...
   subtype DOEPINT0_XFRC_Field is STM32.Bit;
   subtype DOEPINT0_EPDISD_Field is STM32.Bit;
   subtype DOEPINT0_STUP_Field is STM32.Bit;
   subtype DOEPINT0_OTEPDIS_Field is STM32.Bit;
   subtype DOEPINT0_B2BSTUP_Field is STM32.Bit;
   ...
   type DOEPINT_Register is record
      ...
      --  unspecified
      Reserved_7_31 : STM32.UInt25 := 16#1#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DOEPTSIZ0_XFRSIZ_Field is STM32.UInt7;
   subtype DOEPTSIZ0_PKTCNT_Field is STM32.Bit;
   subtype DOEPTSIZ0_STUPCNT_Field is STM32.UInt2;
   ...
   type DOEPTSIZ0_Register is record
      ...
      --  unspecified
      Reserved_20_28 : STM32.UInt9 := 16#0#;
      --  SETUP packet count
   ...
   subtype DOEPCTL1_MPSIZ_Field is STM32.UInt11;
   subtype DOEPCTL1_USBAEP_Field is STM32.Bit;
   subtype DOEPCTL1_EONUM_DPID_Field is STM32.Bit;
   subtype DOEPCTL1_NAKSTS_Field is STM32.Bit;
   subtype DOEPCTL1_EPTYP_Field is STM32.UInt2;
   subtype DOEPCTL1_SNPM_Field is STM32.Bit;
   subtype DOEPCTL1_Stall_Field is STM32.Bit;
   subtype DOEPCTL1_CNAK_Field is STM32.Bit;
   subtype DOEPCTL1_SNAK_Field is STM32.Bit;
   subtype DOEPCTL1_SD0PID_SEVNFRM_Field is STM32.Bit;
   subtype DOEPCTL1_SODDFRM_Field is STM32.Bit;
   subtype DOEPCTL1_EPDIS_Field is STM32.Bit;
   subtype DOEPCTL1_EPENA_Field is STM32.Bit;
   ...
   subtype DOEPTSIZ1_XFRSIZ_Field is STM32.UInt19;
   subtype DOEPTSIZ1_PKTCNT_Field is STM32.UInt10;
   subtype DOEPTSIZ1_RXDPID_STUPCNT_Field is STM32.UInt2;
   ...
   subtype FS_PCGCCTL_STPPCLK_Field is STM32.Bit;
   subtype FS_PCGCCTL_GATEHCLK_Field is STM32.Bit;
   subtype FS_PCGCCTL_PHYSUSP_Field is STM32.Bit;
   ...
   USB_OTG_GLOBAL_Periph : aliased USB_OTG_GLOBAL_Peripheral
     with Import, Address => USB_OTG_GLOBAL_Base;
   ...
   USB_OTG_HOST_Periph : aliased USB_OTG_HOST_Peripheral
     with Import, Address => USB_OTG_HOST_Base;
   ...
   USB_OTG_DEVICE_Periph : aliased USB_OTG_DEVICE_Peripheral
     with Import, Address => USB_OTG_DEVICE_Base;
   ...
   USB_OTG_PWRCLK_Periph : aliased USB_OTG_PWRCLK_Peripheral
     with Import, Address => USB_OTG_PWRCLK_Base;
