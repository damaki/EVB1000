...
package STM32.PWR is
   ...
   subtype CR_LPDS_Field is STM32.Bit;
   subtype CR_PDDS_Field is STM32.Bit;
   subtype CR_CWUF_Field is STM32.Bit;
   subtype CR_CSBF_Field is STM32.Bit;
   subtype CR_PVDE_Field is STM32.Bit;
   subtype CR_PLS_Field is STM32.UInt3;
   subtype CR_DBP_Field is STM32.Bit;
   ...
   subtype CSR_WUF_Field is STM32.Bit;
   subtype CSR_SBF_Field is STM32.Bit;
   subtype CSR_PVDO_Field is STM32.Bit;
   subtype CSR_EWUP_Field is STM32.Bit;
